...
intersphinx_mapping = {
    ...
    'aiida': ('https://aiida-core.readthedocs.io/en/v1.6.5', None),
    'aiida-vasp': ('https://aiida-vasp.readthedocs.io/en/latest', None)
}
...
release = aiida_catmat.__version__
...
html_use_opensearch = 'http://aiida-catmat.readthedocs.io'
...
htmlhelp_basename = 'aiida-catmat-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_catmat')
