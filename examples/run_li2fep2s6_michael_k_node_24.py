...
def example_multistage_workchain_li(vasp_code):
    ...
    builder.vasp_base.vasp.metadata.options.resources = {'parallel_env': 'mpi', 'tot_num_mpiprocs': 24}
    builder.vasp_base.vasp.metadata.options.withmpi = True
    builder.vasp_base.vasp.metadata.options.max_wallclock_seconds = 8 * 60 * 60
    ...
    builder.vasp_base.vasp.metadata.options.custom_scheduler_commands = '#$ -ac allow=K'
